  ...
  <div>
    ...
    <div v-else class="max-w-2xl space-y-6">
      ...
      >
        ...
        >
          <UFormField label="الاسم الكامل" name="name">
          ...
          <UButton type="submit" :loading="savingProfile" class="mt-2">
            حفظ البيانات
          </UButton>
        </UForm>
      </div>
      ...
      >
        ...
        >
          <UFormField label="كلمة المرور الحالية" name="old_password">
            <UInput
          ...
          <UButton type="submit" :loading="savingPassword" class="mt-2">
            تحديث كلمة المرور
          </UButton>
        </UForm>
      </div>
