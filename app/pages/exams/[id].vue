          ...
          <div class="flex-grow text-center md:text-right">
            <div class="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-4">
              <UBadge
                ...
                variant="subtle"
                size="xs"
                class="rounded-lg px-3 font-black uppercase tracking-tighter"
              >
                بنك الأسئلة الرئيسي
              </UBadge>
              <div
    ...
    <div class="sticky top-0 z-30 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-gray-100 dark:border-gray-800">
      <div class="container mx-auto px-4 h-16 flex items-center justify-between">
        <div class="flex items-center gap-4 overflow-x-auto no-scrollbar">
          <NuxtLink
            to="/exams"
            class="text-gray-400 hover:text-primary-500 transition-colors uppercase text-[10px] font-black tracking-widest"
          >الاختبارات</NuxtLink>
          <UIcon
    ...
    <div class="container mx-auto px-4 py-12">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <main class="lg:col-span-8">
          ...
          <div
            v-if="examsStore.loadingExam && !subjects.length"
            class="grid grid-cols-1 md:grid-cols-2 gap-6"
          >
            <div
              v-for="i in 4"
              :key="i"
              class="h-32 rounded-3xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 animate-pulse"
            />
          </div>
          ...
          >
            ...
            >
              ...
              <div class="relative z-10">
                ...
                <div class="flex items-center gap-2">
                  <UBadge
                    ...
                    variant="soft"
                    size="xs"
                    class="rounded-lg font-black"
                  >{{ subject.questions_count || 0 }} سؤال</UBadge>
                  <UBadge
                    color="neutral"
                    variant="soft"
                    size="xs"
              ...
              <div class="pt-4 mt-auto border-t border-gray-50 dark:border-gray-800 relative z-10 flex items-center justify-between text-primary-500 group-hover:text-primary-600 font-black text-sm">
                ...
                <UIcon
                  ...
                  class="w-5 h-5 transform group-hover:translate-x-[-6px] transition-transform"
                />
              </div>
            </NuxtLink>

            <div
              v-if="!examsStore.loadingExam && subjects.length === 0"
            ...
            >
              ...
              <p class="text-gray-400 font-medium">
                سيتم إضافة المحتوى الدراسي لهذا الاختبار قريباً.
              </p>
            </div>
          </div>
        </main>
