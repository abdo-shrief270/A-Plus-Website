...
export const examsService = {
  ...
  getExams: (params?: Record<string, string | number | boolean | undefined>) => {
  ...
  getExamSections: (examId: number | string, params?: Record<string, string | number | boolean | undefined>) => {
    const axios = createAxiosInstance()
