...
export const useQuestionsStore = defineStore('questions', () => {
  ...
  const fetchTrending = async (params: { page?: number, per_page?: number } = {}, append = false) => {
    ...
    try {
      ...
      error.value = (err as { response?: { data?: { message?: string } } }).response?.data?.message || 'Failed to fetch trending questions'
      throw err
    } finally {
  ...
  const fetchRecent = async (params: { page?: number, per_page?: number } = {}, append = false) => {
    ...
    try {
      ...
      error.value = (err as { response?: { data?: { message?: string } } }).response?.data?.message || 'Failed to fetch recent questions'
      throw err
    } finally {
      isLoading.value = false
    }
  ...
  const searchQuestions = async (params: { q: string, per_page?: number, page?: number }, append = false) => {
    ...
    try {
      ...
      error.value = (err as { response?: { data?: { message?: string } } }).response?.data?.message || 'Search failed'
      throw err
    } finally {
      isLoading.value = false
    }
  ...
  const fetchQuestionById = async (id: number | string) => {
    ...
    try {
      ...
      error.value = (err as { response?: { data?: { message?: string } } }).response?.data?.message || 'Failed to fetch question details'
      throw err
    } finally {
      isLoading.value = false
    }
  ...
  const fetchCategoryQuestions = async (categoryId: number | string, params: { paginate?: boolean, per_page?: number, page?: number } = {}, append = false) => {
    ...
    try {
      ...
      if (typeof params.paginate === 'boolean') {
        queryParams.paginate = params.paginate ? 1 : 0
      }
      ...
      error.value = (err as { response?: { data?: { message?: string } } }).response?.data?.message || 'Failed to fetch category questions'
      throw err
    } finally {
      isLoading.value = false
    }
  ...
  const fetchCategoryArticles = async (categoryId: number | string) => {
    ...
    try {
      ...
      error.value = (err as { response?: { data?: { message?: string } } }).response?.data?.message || 'Failed to fetch articles'
      throw err
    } finally {
      isLoading.value = false
    }
  ...
  const fetchArticleById = async (id: number | string) => {
    ...
    try {
      ...
      error.value = (err as { response?: { data?: { message?: string } } }).response?.data?.message || 'Failed to fetch article details'
      throw err
    } finally {
      isLoading.value = false
    }
  ...
  const fetchArticleQuestions = async (articleId: number | string, params: { per_page?: number, page?: number } = {}, append = false) => {
    ...
    try {
      ...
      error.value = (err as { response?: { data?: { message?: string } } }).response?.data?.message || 'Failed to fetch article questions'
      throw err
    } finally {
      isLoading.value = false
    }
  ...
  const fetchTrendingCourses = async (params: { limit?: number } = {}) => {
    ...
    try {
      ...
      error.value = (err as { response?: { data?: { message?: string } } }).response?.data?.message || 'Failed to fetch trending courses'
      throw err
    } finally {
      isLoading.value = false
    }
  ...
  const submitAnswer = async (payload: { question_id: number, answer_id?: number, user_answer?: string }) => {
    ...
    try {
      ...
      error.value = (err as { response?: { data?: { message?: string } } }).response?.data?.message || 'Failed to submit answer'
      throw err
    } finally {
      isLoading.value = false
    }
